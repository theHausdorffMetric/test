...
from kp_scrapers.spiders.port_authorities.osakabay import normalize


class OsakaBaySpider(PortAuthoritySpider, Spider):
    name = 'OsakaBay'
    provider = 'OsakaBay'
    version = '1.1.0'
    ...
    start_urls = [
        # original url: http://www6.kaiho.mlit.go.jp/osakawan/schedule/AKASHI/schedule_3.html
        'https://translate.googleusercontent.com/translate_p?rurl=translate.google.com&sl=auto&sp=nmt4&tl=en&u=http://www6.kaiho.mlit.go.jp/osakawan/schedule/AKASHI/schedule_3.html'  # noqa
    ]
    ...
    def parse_frame(self, response):
        ...
        # only western table is scraped for incoming arrivals
        ...
        for row in table.xpath(".//tr"):
            ...
            # 'Date and time', 'Ship name', 'Ship type', 'Gross tonnage',
